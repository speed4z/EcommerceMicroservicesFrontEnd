  ...
  return (
    <footer className="bg-blue-400 text-white py-6 justify-bottom">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-center md:text-left">
        ...
        <div>
          ...
          <p className="mt-2 text-sm">
            E-commerce platform offering high-quality products at affordable prices.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1">
            ...
            <li><a href="/cart" className="hover:text-blue-300">Cart</a></li>
      ...
      <div className="mt-6 text-center text-sm text-gray-300">
        © 2024 Shardul Shinde. All rights reserved.
      </div>
    </footer>
  );
}
